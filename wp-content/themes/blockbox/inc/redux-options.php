...
Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__('Global Data', 'your-textdomain-here'),
        'id' => 'globaldata',
    ...
    array(
        ...
        'fields' => array(
            array(
                'id'       => 'add-logo',
                'type'     => 'media',
                'title'    => esc_html__( 'Addd logo in header', 'your-textdomain-here' ),
                'compiler'    => 'true',
            ),
            array(
                'id' => 'text-btn',
                'type' => 'text',
                'title' => esc_html__('text button in header', 'your-textdomain-here'),
                'default' => '',
            ),
        )
    )
    ...
    array(
        ...
        'fields' => array(
            array(
                'id' => 'copyright',
                'type' => 'text',
                'title' => esc_html__('Add copyright', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'instlink',
                'type' => 'text',
                'title' => esc_html__('Add instagram link', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'twlink',
                'type' => 'text',
                'title' => esc_html__('Add twitter link', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'youlink',
                'type' => 'text',
                'title' => esc_html__('Add youtube link', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'vklink',
                'type' => 'text',
                'title' => esc_html__('Add vk link', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'fblink',
                'type' => 'text',
                'title' => esc_html__('Add facebook link', 'your-textdomain-here'),
                'default' => '',
            ),
        )
    ));
